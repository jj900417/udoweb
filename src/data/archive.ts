...
export const archive = {
  /* 프로젝트가 무엇을 하려는지 — 기록 허브에서 한 번만 쓴다. */
  philosophy: {
    body:
      '우도의 시간은 빠르게 변하고 있어요. 날씨가 변하고, 풍경이 변하고, 사람들 또한 ' +
      '변해요. 이 아카이브는 우도의 시간을 남기려는 기록이에요.',
  },
  ...
  hub: {
    ...
    lead:
      '사진과 역사와 사람들은 따로 나누지 않아요. 한 장의 사진과 그 시절의 기록, ' +
      '그 기록을 살아낸 사람들의 소리가 있어요.',
    featured: '오늘의 기록',
  ...
  sections: {
    ...
    history: {
      ...
      lead:
        '우도에 사람이 들어와 살기 시작한 때부터 지금까지를, 출처를 밝히며 정리해요. ' +
        '연도가 분명하지 않은 일은 분명하지 않은 채로 적어요.',
    },
    sounds: {
      title: '우도의 소리',
      sub: 'Sounds of Udo',
    ...
    voices: {
      ...
      lead: '우도에서 살아온 분들의 목소리를 그대로 전해요. 말투와 억양, 그 말에 담긴 기억까지.',
    },
  ...
  empty: {
    title: '자료 준비 중',
    body: '아직 공개된 자료가 없어요. 원자료와 권리·동의 확인이 끝나는 대로 이 자리에 올라와요.',
    notFound: '찾는 기록이 없어요',
    notFoundBody: '주소가 바뀌었거나 아직 공개되지 않은 기록이에요.',
    backToArchive: '기록으로 돌아가기',
    structureOnly:
      '지금은 구조만 있고 자료가 없어요. 사진·기록·구술 자료는 권리와 동의 확인이 끝난 것부터 올라와요.',
    peopleNote: '인터뷰와 동의 절차가 끝난 분부터 이 자리에 모셔요. 동의 없이는 이름도 목소리도 올리지 않아요.',
    historyNote: '『우도지』와 공공기록을 확인하며 항목을 하나씩 올려요. 확인되지 않은 연도·사건은 싣지 않아요.',
    libraryNote:
      '『우도지』를 비롯한 자료의 서지정보부터 정리해 올려요. 원문 공개 권리가 없는 책은 소개와 소장처만 실어요.',
  },
  ...
  sound: {
    ...
    sub: 'Sounds of Udo',
    lead:
      '소리는 사진보다 먼저 사라져요. 뱃고동, 숨비소리, 밭담 사이를 지나는 바람을 ' +
      '그 자리에서 녹음해 남겨요. 언제 어디서 녹음했고 그날 날씨가 어땠는지까지 함께 적어요.',
    mapTitle: '소리 지도',
    mapLead: '핀을 누르면 그 자리에서 녹음한 소리가 재생돼요.',
    mapPending: '아직 녹음이 없어 지도에 표시할 자리가 없어요. 첫 녹음이 올라오면 여기에 핀이 찍혀요.',
    recordedAt: '녹음',
    weather: '그날 날씨',
    temp: '기온',
    wind: '바람',
  ...
  voice: {
    ...
    normalSpeed: '보통 속도',
    repeatTitle: '따라 말해보기',
    repeatBody: '한 문장씩 듣고 소리 내어 따라 읽어보세요. 녹음 기능은 준비 중이에요.',
    noAudio: '음성 파일이 아직 없어요.',
    anonymous: '실명 비공개',
    /* 전사 전문은 기본으로 접어 둔다 — 먼저 듣게 하고, 읽고 싶은 사람만 편다. */
    transcript: '전사 읽기',
    transcriptNote: '들리는 대로 옮긴 것이라 표기가 표준어와 다를 수 있어요.',
    seek: '재생 위치',
    playing: '재생 중',
    paused: '멈춤',
    recordedOn: '기록된 날',
  ...
  work: {
    ...
    unknownArtist: '작자 미상',
    publicLabel: '공개',
    rightsNote: '이 사진의 저작권은 권리자에게 있어요. 무단 복제·배포는 할 수 없어요.',
    /* 사진이 없는 기록도 숨기지 않는다 — 없다고 적고 페이지는 유지한다. */
    noImage: '이 자료의 사진은 아직 없어요.',
    groups: {
      identity: '자료',
      creation: '촬영',
      material: '형태',
  ...
  recordNote: {
    title: '이 기록에 대하여',
    body:
      '이 기록은 확인된 만큼만 적혀 있어요. 빠진 것도, 나중에 고쳐질 것도 있어요. ' +
